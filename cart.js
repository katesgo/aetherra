class ShoppingCart {
            ...
            this.items.forEach(item => {
                ...
                itemElement.innerHTML = `
                    ...
                    <div class="flex items-center space-x-2">
                        <button class="text-[#6b6058] hover:text-[#d4a373]" onclick="cart.updateQuantity('${item.id}', -1)">
    ...
    renderPayPalButton() {
        if (window.paypal) {
            ...
            if (container) {
                container.innerHTML = '<p class="text-[#c97b3a] text-sm text-center">PayPal is currently unavailable. Please try again later.</p>';
            }
        }
    }
